...
const whois = async () =>{
  const url = 'https://zozor54-whois-lookup-v1.p.rapidapi.com/?domain=whoisjson.com&format=json&_forceRefresh=0';
  const options = {
    method: 'GET',
    headers: {
...
const Input = () => {
  ...
  return (
    ...
    />
    <button name="Submit" onClick={whois} className="w-[60px] bg-green-500 hover:bg-green-600 text-white flex justify-center items-center rounded-r-md">
